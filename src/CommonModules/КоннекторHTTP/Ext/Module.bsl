...
//                                             **Свойство - Строка - свойство структуры данных,
//                                                                   которое не может быть автоматически сериализовано в JSON.
//                                             **Значение - Строка - значение свойства структуры данных,
//                                                                   которое не может быть автоматически сериализовано в JSON.
...
//      *ДополнительныеПараметрыФункцииПреобразования - Произвольный - параметры, которые будут переданы в функцию ИмяФункцииПреобразования.
