...
// Описание состояния по коду HTTP
//
// Параметры:
//  чКод	 - Число - Код состояния http
// 
// Возвращаемое значение:
//  Строка - Представление кода состояния
//
Функция ОписаниеКодаHTTP(Знач чКод = 0) Экспорт

	VAR сзКодыHTTP, сПредставление, Результат;

	сзКодыHTTP = Новый СписокЗначений;

	///Стандартные
	сзКодыHTTP.Добавить(100, "Continue");
	сзКодыHTTP.Добавить(101, "Switching Protocols");
	сзКодыHTTP.Добавить(102, "Processing");

	сзКодыHTTP.Добавить(200, "OK");
	сзКодыHTTP.Добавить(201, "Created");
	сзКодыHTTP.Добавить(202, "Accepted");
	сзКодыHTTP.Добавить(203, "Non-Authoritative Information");
	сзКодыHTTP.Добавить(204, "No Content");
	сзКодыHTTP.Добавить(205, "Reset Content");
	сзКодыHTTP.Добавить(206, "Partial Content");
	сзКодыHTTP.Добавить(207, "Multi-Status");
	сзКодыHTTP.Добавить(208, "Already Reported");
	сзКодыHTTP.Добавить(226, "IM Used");

	сзКодыHTTP.Добавить(300, "Multiple Choices");
	сзКодыHTTP.Добавить(301, "Moved Permanently");
	сзКодыHTTP.Добавить(302, "Found");
	сзКодыHTTP.Добавить(303, "See Other");
	сзКодыHTTP.Добавить(304, "Not Modified");
	сзКодыHTTP.Добавить(305, "Use Proxy");
	сзКодыHTTP.Добавить(306, "Switch Proxy");
	сзКодыHTTP.Добавить(307, "Temporary Redirect");
	сзКодыHTTP.Добавить(308, "Permanent Redirect");

	сзКодыHTTP.Добавить(400, "Bad Request");
	сзКодыHTTP.Добавить(401, "Unauthorized ");
	сзКодыHTTP.Добавить(402, "Payment Required");
	сзКодыHTTP.Добавить(403, "Forbidden");
	сзКодыHTTP.Добавить(404, "Not Found");
	сзКодыHTTP.Добавить(405, "Method Not Allowed");
	сзКодыHTTP.Добавить(406, "Not Acceptable");
	сзКодыHTTP.Добавить(407, "Proxy Authentication Required");
	сзКодыHTTP.Добавить(408, "Request Timeout");
	сзКодыHTTP.Добавить(409, "Conflict");
	сзКодыHTTP.Добавить(410, "Gone");
	сзКодыHTTP.Добавить(411, "Length Required");
	сзКодыHTTP.Добавить(412, "Precondition Failed");
	сзКодыHTTP.Добавить(413, "Payload Too Large");
	сзКодыHTTP.Добавить(414, "URI Too Long");
	сзКодыHTTP.Добавить(415, "Unsupported Media Type");
	сзКодыHTTP.Добавить(416, "Range Not Satisfiable");
	сзКодыHTTP.Добавить(417, "Expectation Failed");
	сзКодыHTTP.Добавить(418, "I'm a teapot");
	сзКодыHTTP.Добавить(421, "Misdirected Request");
	сзКодыHTTP.Добавить(422, "Unprocessable Entity");
	сзКодыHTTP.Добавить(423, "Locked");
	сзКодыHTTP.Добавить(424, "Failed Dependency");
	сзКодыHTTP.Добавить(426, "Upgrade Required");
	сзКодыHTTP.Добавить(428, "Precondition Required");
	сзКодыHTTP.Добавить(429, "Too Many Requests");
	сзКодыHTTP.Добавить(431, "Request Header Fields Too Large");
	сзКодыHTTP.Добавить(449, "Retry With");
	сзКодыHTTP.Добавить(451, "Unavailable For Legal Reasons");

	сзКодыHTTP.Добавить(500, "Internal Server Error");
	сзКодыHTTP.Добавить(501, "Not Implemented");
	сзКодыHTTP.Добавить(502, "Bad Gateway");
	сзКодыHTTP.Добавить(503, "Service Unavailable");
	сзКодыHTTP.Добавить(504, "Gateway Timeout");
	сзКодыHTTP.Добавить(505, "HTTP Version Not Supported");
	сзКодыHTTP.Добавить(506, "Variant Also Negotiates");
	сзКодыHTTP.Добавить(507, "Insufficient Storage");
	сзКодыHTTP.Добавить(508, "Loop Detected");
	сзКодыHTTP.Добавить(510, "Not Extended");
	сзКодыHTTP.Добавить(511, "Network Authentication Required");

	///Нестандартные
	сзКодыHTTP.Добавить(103, "Checkpoint");
	сзКодыHTTP.Добавить(450, "Blocked by Windows Parental Controls");
	сзКодыHTTP.Добавить(499, "Request has been forbidden by antivirus");
	сзКодыHTTP.Добавить(509, "Bandwidth Limit Exceeded");
	сзКодыHTTP.Добавить(530, "Site is frozen");
	сзКодыHTTP.Добавить(440, "Login Timeout");
	сзКодыHTTP.Добавить(449, "Retry With");
	сзКодыHTTP.Добавить(451, "Redirect");
	сзКодыHTTP.Добавить(444, "No Response");
	сзКодыHTTP.Добавить(495, "SSL Certificate Error");
	сзКодыHTTP.Добавить(496, "SSL Certificate Required");
	сзКодыHTTP.Добавить(497, "HTTP Request Sent to HTTPS Port");
	сзКодыHTTP.Добавить(499, "Client Closed Request");
	сзКодыHTTP.Добавить(520, "Unknown Error");
	сзКодыHTTP.Добавить(521, "Web Server Is Down");
	сзКодыHTTP.Добавить(522, "Connection Timed Out");
	сзКодыHTTP.Добавить(523, "Origin Is Unreachable");
	сзКодыHTTP.Добавить(524, "A Timeout Occurred");
	сзКодыHTTP.Добавить(525, "SSL Handshake Failed");
	сзКодыHTTP.Добавить(526, "Invalid SSL Certificate");

	Результат = сзКодыHTTP.НайтиПоЗначению(чКод);

	If Результат = Неопределено Then
		сПредставление = Формат(чКод, "ЧЦ=3; ЧДЦ=; ЧГ=") + " - Неизвестный код состояния http.";
	Else
		сПредставление = Формат(чКод, "ЧЦ=3; ЧДЦ=; ЧГ=") + " - " + Результат.Представление + ".";
	EndIf;

	Return сПредставление;
...
Функция ОписанияКодовСостоянийHTTP()
	...
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(100, "Продолжай_100", "Continue"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(101, "ПереключениеПротокола_101", "Switching Protocols"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(102, "ИдетОбработка_102", "Processing"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(103, "РанняяМетаинформация_103", "Early Hints"));

	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(200, "ОК_200", "OK"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(201, "Создано_201", "Created"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(202, "Принято_202", "Accepted"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(203, "ИнформацияНеАвторитетна_203", "Non-Authoritative Information"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(204, "НетСодержимого_204", "No Content"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(205, "СброситьСодержимое_205", "Reset Content"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(206, "ЧастичноеСодержимое_206", "Partial Content"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(207, "Многостатусный_207", "Multi-Status"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(208, "УжеСообщалось_208", "Already Reported"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(226, "ИспользованоIM_226", "IM Used"));

	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(300, "МножествоВыборов_300", "Multiple Choices"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(301, "ПеремещеноНавсегда_301", "Moved Permanently"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(302, "ПеремещеноВременно_302", "Moved Temporarily"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(303, "СмотретьДругое_303", "See Other"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(304, "НеИзменялось_304", "Not Modified"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(305, "ИспользоватьПрокси_305", "Use Proxy"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(307, "ВременноеПеренаправление_307", "Temporary Redirect"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(308, "ПостоянноеПеренаправление_308", "Permanent Redirect"));

	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(400, "НеверныйЗапрос_400", "Bad Request"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(401, "НеАвторизован_401", "Unauthorized"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(402, "НеобходимаОплата_402", "Payment Required"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(403, "Запрещено_403", "Forbidden"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(404, "НеНайдено_404", "Not Found"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(405, "МетодНеПоддерживается_405", "Method Not Allowed"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(406, "Неприемлемо_406", "Not Acceptable"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(407, "НеобходимаАутентификацияПрокси_407", "Proxy Authentication Required"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(408, "ИстеклоВремяОжидания_408", "Request Timeout"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(409, "Конфликт_409", "Conflict"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(410, "Удален_410", "Gone"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(411, "НеобходимаДлина_411", "Length Required"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(412, "УсловиеЛожно_412", "Precondition Failed"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(413, "ПолезнаяНагрузкаСлишкомВелика_413", "Payload Too Large"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(414, "СлишкомДлинныйURI_414", "URI Too Long"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(415, "НеподдерживаемыйТипДанных_415", "Unsupported Media Type"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(416, "ДиапазонНеДостижим_416", "Range Not Satisfiable"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(417, "ОжиданиеНеУдалось_417", "Expectation Failed"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(419, "ОшибкаПроверкиCSRF_419", "Authentication Timeout"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(421, "НеправильноНаправленныйЗапрос_421", "Misdirected Request"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(422, "НеобрабатываемыйЭкземпляр_422", "Unprocessable Entity"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(423, "Заблокировано_423", "Locked"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(424, "НевыполненнаяЗависимость_424", "Failed Dependency"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(425, "СлишкомРано_425", "Too Early"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(426, "НеобходимоОбновление_426", "Upgrade Required"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(428, "НеобходимоПредусловие_428", "Precondition Required"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(429, "СлишкомМногоЗапросов_429", "Too Many Requests"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(431, "ПоляЗаголовкаЗапросаСлишкомБольшие_431", "Request Header Fields Too Large"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(449, "ПовторитьС_449", "Retry With"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(451, "НедоступноПоЮридическимПричинам_451", "Unavailable For Legal Reasons"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(499, "КлиентЗакрылСоединение_499", "Client Closed Request"));

	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(500, "ВнутренняяОшибкаСервера_500", "Internal Server Error"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(501, "НеРеализовано_501", "Not Implemented"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(502, "ОшибочныйШлюз_502", "Bad Gateway"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(503, "СервисНедоступен_503", "Service Unavailable"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(504, "ШлюзНеОтвечает_504", "Gateway Timeout"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(505, "ВерсияHTTPНеПоддерживается_505", "HTTP Version Not Supported"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(506, "ВариантТожеПроводитСогласование_506", "Variant Also Negotiates"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(507, "ПереполнениеХранилища_507", "Insufficient Storage"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(508, "ОбнаруженоБесконечноеПеренаправление_508", "Loop Detected"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(509, "ИсчерпанаПропускнаяШиринаКанала_509", "Bandwidth Limit Exceeded"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(510, "НеРасширено_510", "Not Extended"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(511, "ТребуетсяСетеваяАутентификация_511", "Network Authentication Required"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(520, "НеизвестнаяОшибка_520", "Unknown Error"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(521, "ВебСерверНеРаботает_521", "Web Server Is Down"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(522, "СоединениеНеОтвечает_522", "Connection Timed Out"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(523, "ИсточникНедоступен_523", "Origin Is Unreachable"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(524, "ВремяОжиданияИстекло_524", "A Timeout Occurred"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(525, "КвитированиеSSНеУдалось_525", "SSL Handshake Failed"));
	КодыСостояния.Добавить(НовыйКодСостоянияHTTP(526, "НедействительныйСертификатSSL_526", "Invalid SSL Certificate"));

	Возврат КодыСостояния;

КонецФункции

Функция НовыйКодСостоянияHTTP(Код, Ключ, Описание)
