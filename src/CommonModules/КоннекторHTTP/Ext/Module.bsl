...
Функция РассчитатьДлительностьПриостановки(Повтор, КоэффициентЭкспоненциальнойЗадержки, ЗаголовокRetryAfter)
...
Функция НеобходимоПовторитьЗапрос(Ответ, Настройки, ОшибкаВыполненияЗапроса, Повтор, Длительность)
...
Функция ОтправитьЗапрос(Сессия, ПодготовленныйЗапрос, Настройки)
	...
	Пока Истина Цикл
		...
		Если Не НеобходимоПовторитьЗапрос(Ответ, Настройки, ОшибкаВыполненияЗапроса, Повтор, Длительность) Тогда
			Прервать;
		КонецЕсли;
		...
		Приостановить(Мин(ДлительностьПриостановки, Настройки.МаксимальноеВремяПовторов - Длительность));
	КонецЦикла;
