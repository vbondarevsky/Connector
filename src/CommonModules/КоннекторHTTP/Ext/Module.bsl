...
Функция КакJson(Ответ, ПараметрыПреобразованияJSON = Неопределено) Экспорт
	...
	Исключение
		...
		Иначе
			ТекстИсключения = Лев(ТекстОтвета, МаксимальнаяДлинаТекстаИсключения / 2);
			ТекстИсключения = ТекстИсключения + Символы.ПС + "..." + Символы.ПС;
			ТекстИсключения = ТекстИсключения + Прав(ТекстОтвета, МаксимальнаяДлинаТекстаИсключения / 2);
		КонецЕсли;
