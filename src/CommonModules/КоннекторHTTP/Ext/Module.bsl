...
//                  - ДвоичныеДанные - произвольные данные, которые необходимо отправить в запросе.
//    * Файлы - Структура, Массив Из Структура - файлы, которые необходимо отправить в запросе:
...
Функция НовыеПараметры() Экспорт
	...
	Параметры.Вставить("Файлы", Неопределено);
...
//    * КлиентскийСертификатSSL - СертификатКлиентаФайл - см. СертификатКлиентаФайл.
//                              - СертификатКлиентаWindows - см. СертификатКлиентаWindows.
//        Значение по умолчанию: Неопределено.
