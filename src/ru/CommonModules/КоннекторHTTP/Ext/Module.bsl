...
Функция Get(URL, ПараметрыЗапроса = Неопределено, ДополнительныеПараметры = Неопределено, Сессия = Неопределено) Экспорт
	...
	Объединить(Параметры, ДополнительныеПараметры);
...
Функция Объединить(ГлавныйИсточник, ДополнительныйИсточник)
	...
	Дополнить(ГлавныйИсточник, ДополнительныйИсточник, Истина);
	Возврат Результат;
...
Процедура Дополнить(Приемник, Источник, Заменять = Ложь)
	...
	Для Каждого ЭлементИсточника Из Источник Цикл
		...
		Если ПараметрНайден Тогда
			ПараметрНайден = (Приемник[ЭлементИсточника.Ключ] <> Неопределено);
		КонецЕсли;
		
		Если Не ПараметрНайден
		 Или Заменять Тогда
